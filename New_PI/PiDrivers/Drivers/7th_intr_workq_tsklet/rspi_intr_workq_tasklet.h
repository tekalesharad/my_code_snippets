...
//static irqreturn_t pushbtn_irq_handle(int irq , void *data,   struct pt_regs *regs);
static irqreturn_t pushbtn_irq_handle(int irq , void *data);
...
//Tasklet related structure
//
struct tasklet_struct tsklet;
static void   tasklet_bottom_half(unsigned long);
#endif
